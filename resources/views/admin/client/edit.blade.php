...
@section('content')
  ...
  <form id="clientFormEdit" method="POST" action="{{ route('client.update', $client->id) }}" class="max-w-xl mx-auto bg-white p-8 rounded-2xl shadow-lg space-y-6">
    @csrf
    @method('PUT')

    <h2 class="text-2xl font-bold text-center text-indigo-700 mb-6">Edit Client</h2>
    ...
    <div class="text-center">
        <button type="submit"
            ...
            <i class="fas fa-paper-plane mr-2"></i>Update Client
        </button>
    </div>
  </form>
@endsection
